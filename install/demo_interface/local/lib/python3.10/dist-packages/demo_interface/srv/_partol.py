...
class Metaclass_Partol(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from demo_interface.srv import _partol
...
class Partol(metaclass=Metaclass_Partol):
    from demo_interface.srv._partol import Partol_Request as Request
    from demo_interface.srv._partol import Partol_Response as Response
