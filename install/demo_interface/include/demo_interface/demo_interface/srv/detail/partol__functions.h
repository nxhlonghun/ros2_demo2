...
#ifndef DEMO_INTERFACE__SRV__DETAIL__PARTOL__FUNCTIONS_H_
#define DEMO_INTERFACE__SRV__DETAIL__PARTOL__FUNCTIONS_H_
 ...
 * calls
 * demo_interface__srv__Partol_Request__init().
...
/**
 * It calls
 * demo_interface__srv__Partol_Request__fini()
 ...
 * demo_interface__srv__Partol_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * demo_interface__srv__Partol_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * demo_interface__srv__Partol_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_demo_interface
...
/**
 * It calls
 * demo_interface__srv__Partol_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_demo_interface
...
/**
 * It allocates the memory for the array and calls
 * demo_interface__srv__Partol_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_demo_interface
...
/**
 * It calls
 * demo_interface__srv__Partol_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // DEMO_INTERFACE__SRV__DETAIL__PARTOL__FUNCTIONS_H_
