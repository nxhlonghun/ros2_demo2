...
#include "demo_interface/srv/detail/face_detector__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = demo_interface::srv::FaceDetector_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const demo_interface::srv::FaceDetector_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<demo_interface::srv::FaceDetector_Request *>(
    untyped_ros_message);
...
{
  return &demo_interface::srv::typesupport_fastrtps_cpp::_FaceDetector_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = demo_interface::srv::FaceDetector_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const demo_interface::srv::FaceDetector_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<demo_interface::srv::FaceDetector_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &demo_interface::srv::typesupport_fastrtps_cpp::_FaceDetector_Response__handle;
}
...
{
  return &demo_interface::srv::typesupport_fastrtps_cpp::_FaceDetector__handle;
}
