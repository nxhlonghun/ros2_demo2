...
#include "demo_interface/srv/detail/partol__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const demo_interface::srv::Partol_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  demo_interface::srv::Partol_Request & ros_message)
{
  // Member: target_x
  cdr >> ros_message.target_x;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = demo_interface::srv::Partol_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const demo_interface::srv::Partol_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<demo_interface::srv::Partol_Request *>(
    untyped_ros_message);
...
{
  return &demo_interface::srv::typesupport_fastrtps_cpp::_Partol_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, demo_interface, srv, Partol_Request)() {
  return &demo_interface::srv::typesupport_fastrtps_cpp::_Partol_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_demo_interface
cdr_serialize(
  const demo_interface::srv::Partol_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: result
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  demo_interface::srv::Partol_Response & ros_message)
{
  // Member: result
  cdr >> ros_message.result;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = demo_interface::srv::Partol_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const demo_interface::srv::Partol_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<demo_interface::srv::Partol_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &demo_interface::srv::typesupport_fastrtps_cpp::_Partol_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, demo_interface, srv, Partol_Response)() {
  return &demo_interface::srv::typesupport_fastrtps_cpp::_Partol_Response__handle;
}
...
{
  return &demo_interface::srv::typesupport_fastrtps_cpp::_Partol__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, demo_interface, srv, Partol)() {
  return &demo_interface::srv::typesupport_fastrtps_cpp::_Partol__handle;
}
