...
class Metaclass_FaceDetector(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'demo_interface.srv.FaceDetector')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from demo_interface.srv import _face_detector
...
class FaceDetector(metaclass=Metaclass_FaceDetector):
    from demo_interface.srv._face_detector import FaceDetector_Request as Request
    from demo_interface.srv._face_detector import FaceDetector_Response as Response
