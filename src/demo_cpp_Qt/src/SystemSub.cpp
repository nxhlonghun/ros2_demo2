...
namespace SystemSub
{
    namespace NodeSub
    {
        NodeListSub::NodeListSub(const string &node_name, const rclcpp::NodeOptions &options, QObject *parent) : QObject(parent), rclcpp_lifecycle::LifecycleNode(node_name, options)
        {
    ...
    namespace MapSub
    {
        MapSub::MapSub(const string &node_name, QObject *parent) : QObject(parent), rclcpp_lifecycle::LifecycleNode(node_name)
        {
